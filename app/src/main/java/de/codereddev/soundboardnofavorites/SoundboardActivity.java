...
public class SoundboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //File filePath = getFileStreamPath(teetar.png);
        //Drawable d = Drawable.createFromPath(filePath.toString());

        // Declare all sound buttons
        SoundObject[] soundItems = {new SoundObject(nameList.get(0), R.raw.teetargand, R.drawable.teetar), new SoundObject(nameList.get(1), R.raw.chaand,R.drawable.chaand),new SoundObject(nameList.get(2), R.raw.teetar, R.drawable.teetar),new SoundObject(nameList.get(3), R.raw.dubjaa,R.drawable.doobja),new SoundObject(nameList.get(4), R.raw.pyaar,R.drawable.pyaar),new SoundObject(nameList.get(5), R.raw.saal,R.drawable.chaand), new SoundObject(nameList.get(6), R.raw.daring, R.drawable.daring),new SoundObject(nameList.get(7), R.raw.chaakugala,R.drawable.chakugala), new SoundObject(nameList.get(8), R.raw.muutega, R.drawable.muutega), new SoundObject(nameList.get(9), R.raw.chaatri,R.drawable.chatri), new SoundObject(nameList.get(10), R.raw.taabut,R.drawable.taboot), new SoundObject(nameList.get(11), R.raw.gaandu,R.drawable.gandu_jojo), new SoundObject(nameList.get(12), R.raw.aham_brahma,R.drawable.brahma1), new SoundObject(nameList.get(13), R.raw.brahmahuu,R.drawable.brahma2),new SoundObject(nameList.get(14), R.raw.bhagwan,R.drawable.bhagwan),new SoundObject(nameList.get(15), R.raw.make_love,R.drawable.make_love),new SoundObject(nameList.get(16), R.raw.dhandey,R.drawable.teetar)};
